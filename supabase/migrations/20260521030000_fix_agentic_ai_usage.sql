-- Fix: Add 'agentic' action to consume_ai_usage RPC
-- Root cause: agentic workflow calls consume_ai_usage with p_action='agentic'
-- but the CASE statement had no mapping → v_column = NULL → "Unsupported AI action"
