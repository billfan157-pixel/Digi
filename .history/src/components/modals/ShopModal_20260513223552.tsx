        ...
        (() => {
          ...
          return (
            <div className="relative w-16 h-16 mb-3 flex items-center justify-center">
              {frameCfg?.effects}
              <div
                className={`w-14 h-14 rounded-full flex items-center justify-center border-2 bg-slate-800 ${frameCfg?.borderClasses || ''}`}
              >
                <Frame size={20} style={{ color: item.preview_color }} />
              </div>
            </div>
          );
        })()
