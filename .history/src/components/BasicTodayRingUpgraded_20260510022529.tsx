...
function LevelBadge({ level }: { level: number }) {
  return (
    <div className="absolute top-4 left-4 z-20 animate-in fade-in slide-in-from-left duration-300">
      <div 
        className="glass-card-strong px-3 py-2 flex items-center gap-2"
        role="status"
  ...
  return (
    <div className="px-5">
      ...
      <div className="glass-card p-5 pb-4 relative overflow-hidden">
        ...
        {/* Header */}
        <div className="relative z-10 mb-4 pt-12 flex items-start justify-between gap-3">
          <div>
            <div className="flex items-center gap-2">
        ...
        <div className="relative z-10 flex justify-center mb-6">
          <div className="relative h-64 w-64">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center text-center">
              {isCompleted ? (
                <Award size={32} className="mb-2 text-emerald-400" aria-hidden="true" />
                <Award size={26} className="mb-1.5 text-emerald-400" aria-hidden="true" />
              ) : (
                <Droplets size={32} className="mb-2 text-cyan-400" aria-hidden="true" />
                <Droplets size={26} className="mb-1.5 text-cyan-400" aria-hidden="true" />
              )}
              <p className="text-5xl font-black leading-none tracking-tight text-transparent bg-gradient-to-br from-cyan-400 to-cyan-500 bg-clip-text number-glow">
              <p className="text-4xl font-black leading-none tracking-tight text-transparent bg-gradient-to-br from-cyan-400 to-cyan-500 bg-clip-text number-glow">
