import React, { useState, useEffect, useRef } from 'react';
      import { Droplets, CheckCircle2, TrendingUp, TrendingDown, Sparkles, Target, Flame, ChevronDown, ChevronUp, Award } from 'lucide-react';
...
function MilestoneBadge({ text, show }: { text: string; show: boolean }) {
  if (!show) return null;
        ...
        <div className="flex items-center justify-between mb-1 relative z-10">
          <div className="flex-1">
            ...
            Ultimate Progress System
              ...
              {achievementCount === 3 && (
                <div className="flex items-center gap-1">
                  ...
                  <span className="text-[8px] text-yellow-400 font-bold">PERFECT</span>
            ...
            <p className="text-sm text-slate-400 mt-1">
              {achievementText} • {achievementCount}/3 mục tiêu
        ...
        >
          ...
          style={{
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4">
              {achievementCount === 3 ? (
                <Award size={36} className="text-yellow-400 mb-1 animate-pulse" />
            ...
            <Droplets size={36} className="text-cyan-400 mb-2" />
              ...
              <p className="text-5xl leading-none tracking-tight font-black gradient-text-cyan mb-0.5">
