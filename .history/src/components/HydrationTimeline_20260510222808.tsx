  ...
  return (
    <div className={className}>
      ...
      <div className="flex items-center justify-between mb-5 px-1">
        <div className="flex items-center gap-2.5">
          <div className="w-7 h-7 rounded-lg bg-gradient-to-br from-cyan-400 to-blue-500 flex items-center justify-center shadow-[0_0_12px_rgba(34,211,238,0.3)]">
        ...
        <span className="text-[10px] font-medium text-slate-500 bg-slate-800/50 px-2.5 py-1 rounded-full border border-white/5">
          {schedule.length} mốc
        </span>
      </div>
      ...
      {/* Total summary */}
      <div className="mt-4 px-4 py-3 rounded-xl bg-gradient-to-r from-slate-800/60 to-slate-800/20 border border-white/5">
        <div className="flex items-center justify-between text-xs">
          <span className="text-slate-400 font-medium">Tổng lượng nước</span>
          <span className="text-white font-bold tabular-nums">
            {schedule.reduce((sum, s) => sum + s.amount, 0).toLocaleString('vi-VN')}
            <span className="text-slate-400 font-medium ml-1">ml</span>
          </span>
        </div>
      </div>
    </div>
