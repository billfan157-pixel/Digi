    ...
    <div className="space-y-3">
      ...
      <div className="rounded-[1.5rem] bg-slate-900/80 border border-white/10 backdrop-blur-xl p-4 overflow-hidden relative">
        ...
        <div className="flex items-start justify-between gap-4 relative z-10">
          <div>
            <p className="text-[11px] uppercase tracking-[0.28em] text-cyan-300/70 font-black">Demo Link</p>
            <h2 className="text-lg font-black text-white mt-2">{isConnected ? 'Bottle demo đang hoạt động' : 'Thiết bị demo đang chờ bật'}</h2>
            <p className="text-sm text-slate-400 mt-2 max-w-[17rem]">{isConnected ? 'Đây là luồng mô phỏng telemetry để kiểm thử UI, không phải ghép nối phần cứng thật.' : 'Bật demo để xem giao diện thiết bị và các control mô phỏng.'}</p>
