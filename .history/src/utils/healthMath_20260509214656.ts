...
export const STREAK_TIERS: StreakTier[] = [
  { name: 'Đồng', emoji: '🥉', minStreak: 0, maxStreak: 6, color: 'text-amber-700', bg: 'bg-amber-900/20', border: 'border-amber-700/50', xpMultiplier: 1.0, description: 'Khởi đầu' },
  { name: 'Bạc', emoji: '🥈', minStreak: 7, maxStreak: 13, color: 'text-slate-300', bg: 'bg-slate-400/20', border: 'border-slate-300/50', xpMultiplier: 1.1, description: 'Kiên trì' },
  { name: 'Vàng', emoji: '🥇', minStreak: 14, maxStreak: 29, color: 'text-yellow-400', bg: 'bg-yellow-500/20', border: 'border-yellow-400/50', xpMultiplier: 1.25, description: 'Kỷ luật' },
  { name: 'Kim Cương', emoji: '💎', minStreak: 30, maxStreak: 59, color: 'text-cyan-400', bg: 'bg-cyan-500/20', border: 'border-cyan-400/50', xpMultiplier: 1.5, description: 'Tinh thần thép' },
  { name: 'Huyền Thoại', emoji: '👑', minStreak: 60, maxStreak: null, color: 'text-rose-400', bg: 'bg-rose-500/20', border: 'border-rose-400/50', xpMultiplier: 2.0, description: 'Bất tử' },
];
