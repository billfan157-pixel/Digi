...
const EMPTY_STATE_BY_FILTER: Record<FeedFilter, { title: string; description: string }> = {
  ...
  tips: {
    title: 'Chưa có mẹo hydration nào',
    description: 'Chia sẻ bí quyết uống nước của bạn với cộng đồng.',
  },
  polls: {
    title: 'Chưa có khảo sát nào',
    description: 'Tạo câu hỏi để cộng đồng cùng thảo luận.',
  },
  photos: {
    title: 'Chưa có khoảnh khắc nào',
    description: 'Chụp ảnh ly nước của bạn và lan tỏa cảm hứng.',
  },
};
