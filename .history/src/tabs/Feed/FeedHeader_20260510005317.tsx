        ...
        <div className="flex justify-between items-start mb-5">
          ...
          <div className="flex items-center gap-2 shrink-0">
            ...
            <button
              ...
              className="hidden sm:flex items-center gap-1.5 px-3 py-2 rounded-xl bg-cyan-500/10 border border-cyan-500/20 text-cyan-300 text-xs font-bold hover:bg-cyan-500/20 active:scale-95 transition-all"
            >
