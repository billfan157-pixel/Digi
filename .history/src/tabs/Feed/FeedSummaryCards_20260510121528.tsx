      ...
      <AnimatePresence initial={false}>
        {isExpanded && (
            ...
            <div className="grid grid-cols-3 gap-3 pb-2">
              ...
              <div className="glass-card border-emerald-500/20 bg-emerald-500/10 p-3">
                <p className="section-label text-emerald-300">Mẹo</p>
                <p className="mt-2 text-2xl font-black text-white">{summary.tipCount}</p>
                <p className="text-xs text-emerald-100/70">bí quyết hay</p>
              </div>
              <div className="glass-card border-amber-500/20 bg-amber-500/10 p-3">
                <p className="section-label text-amber-300">Khảo sát</p>
                <p className="mt-2 text-2xl font-black text-white">{summary.pollCount}</p>
                <p className="text-xs text-amber-100/70">đang mở</p>
              </div>
import { useState } from 'react';
import { ChevronDown } from 'lucide-react';
import { motion, AnimatePresence } from 'framer-motion';
