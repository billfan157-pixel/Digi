...
import { Share2, Heart, Zap, Target, MoreHorizontal, MessageCircle, Globe, Droplets, Swords, CheckCircle2, Trash2, Flag, Edit2, Flame, CloudSun, HeartPulse, Coffee, Bookmark, Trophy, Sparkles } from 'lucide-react';
...
export const PostCard = memo(({ post, currentUserId, handleToggleLikePost, onOpenComments }: PostCardProps) => {
  ...
  const handleCheers = async () => {
    ...
    // 2. Optimistic UI (toast loading thay vì success)
    setHasCheered(true);
    ...
    try {
      ...
      setHasCheered(false);
      toast.error('Lỗi máy chủ, chưa thể cộng nước!', { id: tid });
    }
  };
