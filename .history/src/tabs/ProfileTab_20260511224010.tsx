  ...
  return <div className="animate-in slide-in-from-right duration-300 space-y-5 pb-6">
    <div className="flex justify-between items-center pt-2 pb-3 px-6 relative z-20">
      <div className="flex-1 pr-4">
        <p className="section-title text-slate-400 mb-1.5">THÔNG TIN CÁ NHÂN</p>
      ...
      <div className="flex items-center gap-2 shrink-0">
        {isPremium && (
          <div className="px-3 py-1.5 rounded-xl text-[10px] font-bold text-amber-400 bg-amber-500/10 border border-amber-500/30 flex items-center gap-1">
            <Sparkles size={12} /> PRO
          </div>
        )}
        <button className="w-11 h-11 rounded-xl bg-slate-800/60 backdrop-blur-md border border-white/10 flex items-center justify-center text-slate-400 hover:text-cyan-400 hover:bg-cyan-500/15 active:scale-90 transition-all duration-200 ease-out shadow-sm hover:shadow-[0_0_15px_rgba(6,182,212,0.2)] group">
