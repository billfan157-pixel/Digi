...
import {
  ...
  CloudSun, Calendar, Target, Settings2
} from 'lucide-react';
...
<div className="flex items-center gap-3">
        ...
        <div className="shrink-0">
          <div className="active:scale-95 transition-all rounded-full shadow-lg shadow-black/20 hover:shadow-cyan-500/20">
            <AvatarFrame size="sm" level={profile?.level || 1} avatarUrl={profile?.avatar_url ?? null} nickname={profile?.nickname} showBadge={false} />
          </div>
        </div>
      </div>
      ...
      <div className="px-5 mb-6 mt-1">
        <div className="flex items-center bg-slate-900/80 backdrop-blur-2xl p-1.5 rounded-[1.25rem] border border-white/5 shadow-inner">
          {[
            ...
            return (
              <button
                ...
                className={`flex-1 relative flex flex-col items-center justify-center py-2.5 transition-all duration-300 z-10 rounded-xl ${
              ...
              >
                {isActive && (
                  <motion.div
                    ...
                    className="absolute inset-0 bg-slate-800/80 border border-white/10 rounded-xl shadow-[0_4px_12px_rgba(0,0,0,0.5)] -z-10"
                    transition={{ type: "spring", bounce: 0.2, duration: 0.6 }}
                  />
                )}
                {isActive && (
                  <div className="absolute -top-1.5 w-6 h-1 bg-cyan-400 rounded-full blur-[2px] opacity-70" />
                )}
                <Icon size={16} className={`mb-1.5 ${isActive ? 'drop-shadow-[0_0_8px_rgba(34,211,238,0.8)]' : 'opacity-70'}`} />
          ...
          >
            ...
            <div className="px-6 mb-3">
              ...
              <motion.p 
                ...
                className="mt-1 text-xs text-slate-400 leading-relaxed line-clamp-2"
              >
                {primaryStory}
              </motion.p>
            </div>
