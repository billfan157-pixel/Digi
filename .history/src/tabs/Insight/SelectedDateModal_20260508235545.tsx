              ...
              if (displayLogs.length === 0) {
                return (
                  <div className="text-center py-16 flex-1">
                    ...
                    <button onClick={onClose} className="px-6 py-3 rounded-2xl bg-cyan-500/10 text-cyan-400 font-bold text-sm active:scale-95 transition-all border border-cyan-500/20 hover:bg-cyan-500/20">
                      Đóng
                    </button>
                  </div>
                );
