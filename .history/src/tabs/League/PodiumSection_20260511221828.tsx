        ...
        return (
          ...
          >
            ...
            <div className="relative mb-2.5">
              <div
                className={`rounded-full overflow-hidden flex items-center justify-center font-black border-[2.5px] ${metal.border} bg-gradient-to-br ${metal.bg} backdrop-blur-sm ${
                  isChampion
                    ? 'w-[60px] h-[60px] text-2xl shadow-[0_0_25px_rgba(250,204,21,0.25)]'
                    : 'w-[46px] h-[46px] text-lg shadow-[0_0_12px_rgba(255,255,255,0.06)]'
                }`}
              >
              ...
              <div
                className={`absolute left-1/2 -translate-x-1/2 rounded-full flex items-center justify-center font-black border-2 border-slate-900 bg-gradient-to-br ${metal.rankBg} ${metal.rankText} ${
                  isChampion
                    ? 'w-7 h-7 -bottom-2 text-[11px] shadow-[0_0_10px_rgba(250,204,21,0.3)]'
                    : 'w-5 h-5 -bottom-1.5 text-[9px]'
                }`}
              >
                {podiumIndex + 1}
              </div>
            ...
            >
              ...
              {/* Streak decoration line for champ */}
              {isChampion && (
                <div className="absolute bottom-0 left-0 right-0 h-[2px] bg-gradient-to-r from-transparent via-yellow-400/40 to-transparent" />
              )}
