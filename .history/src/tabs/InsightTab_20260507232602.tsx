...
const InsightTab = memo(function InsightTab({
  ...
  const { profile, isPremium, waterGoal, weeklyHistory: weeklyChartData, streak, hydrationResult, waterIntake, waterEntries, isWatchConnected, isWeatherSynced } = useAppStore(useShallow((state: any) => ({
  ...
  const isCalendarSynced = useMemo(() => {
