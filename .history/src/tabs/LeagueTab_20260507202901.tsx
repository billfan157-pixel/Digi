  ...
  return (
    <div className="animate-in slide-in-from-right duration-300 relative space-y-5 pb-6">
      ...
      <div className="relative z-0 space-y-5">
          ...
          <div className="flex justify-between items-start pt-2 pb-1 px-1">
            <div>
              <p className="text-[11px] font-bold tracking-widest text-slate-400 uppercase mb-1.5">
                BẢNG VINH DANH
              </p>
          ...
          <div className="flex p-1.5 bg-slate-900/60 backdrop-blur-xl rounded-2xl border border-white/10 mx-1 shadow-2xl relative">
            <button 
