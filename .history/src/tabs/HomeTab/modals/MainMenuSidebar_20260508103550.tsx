          ...
          >
            ...
            <div className="p-4 space-y-6 flex-1 overflow-y-auto scrollbar-hide">
              ...
              {profile && (
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-cyan-600 dark:text-cyan-400 text-[10px] font-bold uppercase tracking-wider mt-0.5">Thành viên hạng {profile.level || 1}</p>
                  </div>
                </div>
              )}
              ...
              <div className="space-y-3">
                <h4 className="text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-2">Chỉ số thành viên</h4>
