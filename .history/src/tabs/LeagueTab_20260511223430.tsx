      ...
      <div className="sticky top-0 z-30 bg-slate-950/80 backdrop-blur-xl border-b border-white/[0.04]">
        <div className="flex justify-between items-center pt-2 pb-3 px-6 relative z-20">
          ...
          <div className="flex items-center gap-2 shrink-0">
            <button className="w-11 h-11 rounded-xl bg-slate-800/60 backdrop-blur-md border border-white/10 flex items-center justify-center text-yellow-400 hover:bg-yellow-500/15 active:scale-90 transition-all duration-200 ease-out shadow-sm hover:shadow-[0_0_15px_rgba(250,204,21,0.2)] group">
              <Medal size={18} className="group-hover:scale-110 transition-transform" />
            </button>
