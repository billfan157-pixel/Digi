    ...
    <div className="space-y-6 pb-28 animate-in fade-in duration-300">
      ...
      <div className="flex justify-between items-center pt-2 pb-3 px-6 relative z-20">
        <div className="flex-1 pr-4">
          <p className="section-title text-slate-400 mb-1.5">Huấn luyện thông minh</p>
          <h1 className="text-3xl font-black tracking-tighter text-white leading-tight">
            DigiCoach
          </h1>
        </div>
        <div className="flex items-center gap-2 shrink-0">
          <button className="w-11 h-11 rounded-xl bg-slate-800/60 backdrop-blur-md border border-white/10 flex items-center justify-center text-cyan-400 hover:bg-cyan-500/15 active:scale-90 transition-all duration-200 ease-out shadow-sm hover:shadow-[0_0_15px_rgba(6,182,212,0.2)] group">
            <Cpu size={18} className="group-hover:scale-110 transition-transform" />
          </button>
          <div onClick={handleSecretClick} className="rounded-full active:scale-90 transition-all duration-200 ease-out flex items-center justify-center hover:scale-105 cursor-pointer">
