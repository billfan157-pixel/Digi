...
export default function EditEntryModal() {
  ...
  const setEditingEntry = useUIStore(s => s.setEditingEntry);
  const editAmount = useUIStore(s => s.editAmount);
  const setEditAmount = useUIStore(s => s.setEditAmount);
  const handleEditEntry = useAppStore(s => s.actions.handleEditEntry);
