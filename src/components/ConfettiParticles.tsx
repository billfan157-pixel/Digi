...
export const ConfettiParticles: React.FC<ConfettiParticlesProps> = ({ trigger }) => {
  const [particles, setParticles] = useState<
    { id: number; x: number; y: number; color: string; rotateMid: number; rotateEnd: number }[]
  >([]);
        ...
        {particles.map(p => (
          <motion.div
            ...
            animate={{ 
              ...
              scale: [0, 1.5, 1],
              rotate: [0, p.rotateMid, p.rotateEnd], // Xoay vòng trong không gian
