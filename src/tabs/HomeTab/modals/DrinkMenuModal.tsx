        ...
        <div key="drink-menu-modal" className="fixed inset-0 z-[100] flex flex-col justify-end">
          ...
          >
            ...
            <AnimatePresence mode="wait">
              {isCustomMode ? (
                ...
                >
                  ...
                  <button
                    onClick={() => { resetCustom(); setIsCustomMode(true); }}
            ...
            <div className="pt-4 mt-auto border-t border-white/10">
              <button
                onClick={() => { onClose(); resetCustom(); }}
                className="w-full py-4 rounded-2xl bg-gradient-to-r from-cyan-500 to-blue-500 text-slate-950 font-bold hover:from-cyan-400 hover:to-blue-400 active:scale-95 transition-all shadow-[0_0_20px_rgba(6,182,212,0.4)] hover:shadow-[0_0_25px_rgba(6,182,212,0.6)]"
              >
                {t('home.done')}
              </button>
            </div>
