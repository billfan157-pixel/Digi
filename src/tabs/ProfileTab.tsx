  ...
  return <div className="animate-in slide-in-from-right duration-300 space-y-5 pb-6">
    <div className="flex justify-between items-start pt-6 pb-4 px-6">
      ...
      <div className="flex items-center gap-3">
        {!isPremium ? null : <div className="px-3 py-1.5 rounded-lg text-[10px] font-bold text-amber-400 bg-amber-500/10 border border-amber-500/30 flex items-center gap-1">
            <Sparkles size={12} /> PRO
          </div>}
        <button className="active:scale-95 transition-all rounded-full shadow-lg shadow-white/10 hover:shadow-cyan-500/20">
