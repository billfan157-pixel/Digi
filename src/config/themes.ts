...
export type GlassPattern = 'none' | 'gradient' | 'grid' | 'scanline' | 'diagonal';
...
export const APP_THEMES: Record<string, ThemeConfig> = {
  ...
  th_purple: {
    ...
    glassPattern: 'gradient', glassGlowIntensity: 0.2, glassInnerGlow: true, glassGradient: 'linear-gradient(to bottom right, rgba(168,85,247,0.1), transparent)', glassHoverEffect: 'brightness'
  },
  th_rose: {
  ...
  theme_aurora: {
    ...
    glassPattern: 'gradient', glassGlowIntensity: 0.3, glassInnerGlow: true, glassGradient: 'linear-gradient(to bottom right, rgba(167,139,250,0.2), rgba(232,121,249,0.1), transparent)', glassHoverEffect: 'brightness'
  },
  theme_cyan: {
    ...
    glassPattern: 'grid', glassGlowIntensity: 0.4, glassInnerGlow: false, glassHoverEffect: 'glow'
  },
  theme_cyber: {
    ...
    glassPattern: 'grid', glassGlowIntensity: 0.5, glassInnerGlow: false, glassHoverEffect: 'glow'
  },
  theme_cyberpunk: {
  ...
  theme_emerald: {
    ...
    glassPattern: 'gradient', glassGlowIntensity: 0.2, glassInnerGlow: true, glassGradient: 'linear-gradient(to bottom right, rgba(34,197,94,0.15), transparent)', glassHoverEffect: 'brightness'
  },
  theme_forest: {
    ...
    glassPattern: 'gradient', glassGlowIntensity: 0.2, glassInnerGlow: true, glassGradient: 'linear-gradient(to bottom right, rgba(5,150,105,0.1), transparent)', glassHoverEffect: 'brightness'
  },
  theme_midnight: {
  ...
  theme_red: {
    ...
    glassPattern: 'gradient', glassGlowIntensity: 0.3, glassInnerGlow: true, glassGradient: 'linear-gradient(to bottom right, rgba(220,38,38,0.1), transparent)', glassHoverEffect: 'glow'
  },
  theme_royal: {
    ...
    glassPattern: 'gradient', glassGlowIntensity: 0.5, glassInnerGlow: true, glassGradient: 'linear-gradient(to bottom right, rgba(251,191,36,0.25), transparent)', glassHoverEffect: 'glow'
  },
  theme_sakura: {
    ...
    glassPattern: 'gradient', glassGlowIntensity: 0.2, glassInnerGlow: true, glassGradient: 'linear-gradient(to bottom right, rgba(251,207,232,0.15), transparent)', glassHoverEffect: 'brightness'
  },
  theme_sunset: {
    ...
    glassPattern: 'gradient', glassGlowIntensity: 0.25, glassInnerGlow: true, glassGradient: 'linear-gradient(to bottom right, rgba(249,115,22,0.15), transparent)', glassHoverEffect: 'brightness'
  },
  theme_yellow: {
    ...
    glassPattern: 'gradient', glassGlowIntensity: 0.2, glassInnerGlow: true, glassGradient: 'linear-gradient(to bottom right, rgba(253,224,71,0.15), transparent)', glassHoverEffect: 'brightness'
  },
};
